...
BEGIN           
	...
	--tempo que demoraria para o sistema popular a ram - SL01 ate SL04
	wait for 500 ns;
	
	sttIMenor13 <= '0';
	
	wait for 20 ns;
	--Escrita da carta na memoria
	...
	wait for 15 ns;
	--Chegada de Sinal que demonstra que a carta encontra-se disponível
	...
	wait for 20 ns;
	--Teste para os sinais quando os pontos são maior que 16
	
	sttPontosMaiorDezesseis <= '0';
	
	wait for 20 ns;
	
	sttPontosMaiorVinte <= '1';
